class AnimaUtil {
	public static showMoive(frameName:string, container: egret.DisplayObjectContainer,playerCompleteCallback?:Function,isLoop?:boolean, x?, y?, width?, high?) {
		...
		behavior2.addEventListener(egret.Event.LOOP_COMPLETE, function (e: egret.Event): void {
